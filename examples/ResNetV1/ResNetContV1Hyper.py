...
path = 'results/Guassian1DConvV14/'

HP_FILTER = hp.HParam('fitler_size', hp.Discrete([8, 16, 32, 64]))
HP_ACT = hp.HParam('act_fun', hp.Discrete(
    ['softplus', 'sigmoid', 'exponential'])
)

HP_KERNEL =  hp.HParam('kernel_size', hp.Discrete([50, 100, 150, 200]))
...
log_dir = 'logs/hparam_tuning_sec_run/'
